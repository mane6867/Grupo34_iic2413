...
with open('Grupo34_iic2413/datos2/direcciones_clientes.csv','r') as info:
    direcciones = []
    for linea in info:
        calle_num_ubi = linea[:-1].split(";")
        direcciones.append(calle_num_ubi)
    direcciones[-1] = ['Mills Fort', '2954', '234']
info.close()
...
with open('Grupo34_iic2413/datos2/ids_direcciones_clientes.csv', 'w') as file:
